...
$(TARGET): $(MAIN_O) $(MAKE_IPV4_O) $(MAKE_TCP_O) $(RECEIVER_O) $(SUBNET_MASK_O) $(GET_FLOOD_O) $(CONN_FLOOD_O) $(SYN_FLOOD_O) $(UDP_FLOOD_O) $(ICMP_FLOOD_O) $(HASH_DOS_O)
	$(CC) $(MAIN_O) $(MAKE_IPV4_O) $(MAKE_TCP_O) $(RECEIVER_O) $(SUBNET_MASK_O) $(GET_FLOOD_O) $(CONN_FLOOD_O) $(SYN_FLOOD_O) $(UDP_FLOOD_O) $(ICMP_FLOOD_O) $(HASH_DOS_O) $(RENAME) $(TARGET).out $(LINKOPTS)

$(MAIN_O): $(MAIN_C) $(HEADER) $(GET_FLOOD_H) $(ICMP_FLOOD_H) $(SYN_FLOOD_H) $(UDP_FLOOD_H) $(CONN_FLOOD_H) $(HASH_DOS_H)
