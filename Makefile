...
$(TARGET): $(MAIN_O) $(MAKE_IPV4_O) $(MAKE_TCP_O) $(RECEIVER_O) $(SUBNET_MASK_O) $(GET_FLOOD_O) $(CONN_FLOOD_O) $(SYN_FLOOD_O) $(UDP_FLOOD_O) $(ICMP_FLOOD_O) $(HASH_DOS_O) $(HEADER_BUFFERING_O) $(RESPONSE_BUFFERING_O) $(BODY_BUFFERING_O) 
	$(CC) $(MAIN_O) $(MAKE_IPV4_O) $(MAKE_TCP_O) $(RECEIVER_O) $(SUBNET_MASK_O) $(GET_FLOOD_O) $(CONN_FLOOD_O) $(SYN_FLOOD_O) $(UDP_FLOOD_O) $(ICMP_FLOOD_O) $(HASH_DOS_O) $(HEADER_BUFFERING_O) $(RESPONSE_BUFFERING_O) $(BODY_BUFFERING_O) $(RENAME) $(TARGET).out $(LINKOPTS)
