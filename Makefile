...
$(TARGET): $(MAIN_O) $(MAKE_IPV4_O) $(MAKE_TCP_O) $(RECEIVER_O) $(SUBNET_MASK_O) $(TIME_CHECK_O) $(GET_FLOOD_O) $(CONN_FLOOD_O) $(SYN_FLOOD_O) $(UDP_FLOOD_O) $(ICMP_FLOOD_O) $(HASH_DOS_O) $(HEADER_BUFFERING_O) $(RESPONSE_BUFFERING_O) $(BODY_BUFFERING_O) 
...
$(CLEAN):
	rm $(OBJ_DIR)*.o
>>>>>>> 921c040880abfb9c9a57ff464f0c2f5b69c52942
